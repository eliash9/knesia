...
<body>
    ...
    <div class="printpage">	
        <div class="header"><img src="<?php echo html_escape($bu).html_escape(@$setting->logo);?>" height="75" alt="<?php echo html_escape(@$setting->website_title);?>"  title="<?php echo html_escape(@$setting->website_title);?>" /></div>
