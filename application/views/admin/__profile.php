        ...
        <div class="row">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center">
                            <div class="col ">
                                <img src="<?php echo  html_escape($img); ?>" class="img-responsive img-thumbnail" width="175">
                            </div>

                            <div class="col-auto margin-top10">
                                <?php
                                    echo form_open_multipart('admin/photo_upload/user_photo');
                                ?>
            ...
            <div class="col-lg-9">
                <div class="card">
                    ...
                    <?php echo form_open_multipart('admin/profile/update_user_info');?>
