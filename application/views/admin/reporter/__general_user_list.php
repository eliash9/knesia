                    ...
                    <div class="card-body">
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                       <a href="<?php echo base_url()?>admin/general_user/delete_user/<?php echo html_escape($user_list['id']);?>" onclick="return confirm('<?php echo display('do_you_want_to_delete_this')?>')" class="btn btn-danger btn-sm"><i class="fa fa-trash "></i></a>
                                    </td>
